...
Signature.prototype.recoverPublicKeyFromBuffer = function(buffer) {
...
/**
    @return {PublicKey}
*/
Signature.prototype.recoverPublicKey = function(sha256_buffer) {
    var Q, e, i;
...
/**
    ...
    @return {Signature}
*/
Signature.signBuffer = function(buf, private_key) {
...
/** Sign a buffer of exactally 32 bytes in size (sha256(text))
    ...
    @return {Signature}
*/
Signature.signBufferSha256 = function(buf_sha256, private_key) {
...
Signature.sign = function(string, private_key) {
...
/**
    ...
    @return {boolean}
*/
Signature.prototype.verifyBuffer = function(buf, public_key) {
    var _hash = hash.sha256(buf);
    return this.verifyHash(_hash, public_key);
};

Signature.prototype.verifyHash = function(hash, public_key) {
...
Signature.prototype.toByteBuffer = function() {
    var b;
...
Signature.signHex = function(hex, private_key) {
    var buf;
    buf = new Buffer(hex, 'hex');
    return Signature.signBuffer(buf, private_key);
};

Signature.prototype.verifyHex = function(hex, public_key) {
    var buf;
    buf = new Buffer(hex, 'hex');
    return this.verifyBuffer(buf, public_key);
};

var toPrivateObj = function (o) {
